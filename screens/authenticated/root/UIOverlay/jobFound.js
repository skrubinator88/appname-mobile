			...
			<Card ref={cardRef}>
				{!loading && job_data ?
					<View>
						...
						<CardOptionItem activeOpacity={1} style={{ justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center' }} row>
						...
						<CardOptionItem onPress={() => navigation.navigate("Job Details", { data: job_data })} activeOpacity={1} style={{ justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center' }} row>
						...
						<Row last>
							<Column>
								<Button disabled={loading} decline onPress={() => handleJobDecline()}>
